...
/**
  Generates item stats, so all items have the same
*/
...
// Base player stats
var basePlayerStats=;
var basePlayer=new Item({name:'Leukocyt', description: 'You, a white globule', canMove:true, stats: {life:50, damage:10, strenght:1, level:1}, className:'player'});
