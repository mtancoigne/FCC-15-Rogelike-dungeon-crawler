...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var MapGen = function MapGen(base, reductions, cleanup) {
	  /**
	  ...
	  */
	  this._createMap = function (base, reductions, cleanup) {
	    ...
	    // Closing the map
	    for (var _i2 = 0; _i2 < this.grid.length; _i2++) {
	      for (var _j2 = 0; _j2 < this.grid.length; _j2++) {
	        if (_i2 === 0 || _i2 === this.grid.length - 1 || _j2 === 0 || _j2 === this.grid.length - 1) {
	          this.grid[_i2][_j2] = true;
	        }
	      }
	    }
	    ...
	    if (cleanup === true) {
	      for (var _i3 = 0; _i3 < this.grid.length; _i3++) {
	        for (var _j3 = 0; _j3 < this.grid.length; _j3++) {
	          this.grid[_i3][_j3] = this._isIsolated(_i3, _j3);
	        }
	      }
	    }
	  };
	  ...
	  this._checksum = function (x, y) {
	    ...
	    // Corners: outside
	    if (['111111110', '000000001'].indexOf(sum) >= 0) {
	      return 'otl';
	    }
	    if (['111111011', '000000100'].indexOf(sum) >= 0) {
	      return 'otr';
	    }
	    if (['110111111', '001000000'].indexOf(sum) >= 0) {
	      return 'obl';
	    }
	    if (['011111111', '100000000'].indexOf(sum) >= 0) {
	      return 'obr';
	    }
	
	    // Corners: inside
	    if (['000011011', '111100100'].indexOf(sum) >= 0) {
	      return 'itl';
	    }
	    if (['000110110', '111001001'].indexOf(sum) >= 0) {
	      return 'itr';
	    }
	    if (['011011000', '100100111'].indexOf(sum) >= 0) {
	      return 'ibl';
	    }
	    if (['110110000', '001001111'].indexOf(sum) >= 0) {
	      return 'ibr';
	    }
	
	    // Corners: between
	    if (['111100101', '000011010'].indexOf(sum) >= 0) {
	      return 'btl';
	    }
	    if (['111001101', '000110010'].indexOf(sum) >= 0) {
	      return 'btr';
	    }
	    if (['101100111', '010011000'].indexOf(sum) >= 0) {
	      return 'bbl';
	    }
	    if (['101001111', '010110000'].indexOf(sum) >= 0) {
	      return 'bbr';
	    }
	
	    // Line blocks
	    if (['000111111', '111000000', '001111111', '110000000', '110111111', '010000000', '100111111', '011000000'].indexOf(sum) >= 0) {
	      return 'it';
	    }
	    if (['011011011', '100100100', '111011011', '000100100', '111011111', '000100000', '011011111', '100100000'].indexOf(sum) >= 0) {
	      return 'il';
	    }
	    if (['111111000', '000000111', '111111001', '000000110', '111111101', '000000010', '111111100', '000000011'].indexOf(sum) >= 0) {
	      return 'ib';
	    }
	    if (['110110110', '001001001', '111110110', '000001001', '111110111', '000001000', '110110111', '001001000'].indexOf(sum) >= 0) {
	      return 'ir';
	    }
	    // Simple tiles
	    if (['000010010', '111101101'].indexOf(sum) >= 0) {
	      return 'svt';
	    }
	    if (['010010010', '101101101', '110010010', '001101101', '011010010', '100101101', '010010011', '101101100', '010010110', '101101001', '011010011', '100101100', '110010110', '001101001', '111010010', '000101101', '101101000', '010010111'].indexOf(sum) >= 0) {
	      return 'svm';
	    }
	    if (['010010000', '101101111'].indexOf(sum) >= 0) {
	      return 'svb';
	    }
	    if (['000011000', '111100111'].indexOf(sum) >= 0) {
	      return 'shl';
	    }
	    if (['000111000', '111000111', '000111100', '111000011', '100111000', '011000111', '001111000', '110000111', '000111001', '111000110', '000111101', '111000010', '101111000', '010000111', '100111100', '011000011', '001111001', '110000110'].indexOf(sum) >= 0) {
	      return 'shm';
	    }
	    if (['000110000', '111001111'].indexOf(sum) >= 0) {
	      return 'shr';
	    }
	    // Intersections
	    if (['000111010', '111000101'].indexOf(sum) >= 0) {
	      return 'stt';
	    }
	    if (['010110010', '101001101'].indexOf(sum) >= 0) {
	      return 'str';
	    }
	    if (['010111000', '101000111'].indexOf(sum) >= 0) {
	      return 'stb';
	    }
	    if (['010011010', '101100101'].indexOf(sum) >= 0) {
	      return 'stl';
	    }
	    // Alone
	    if (['000010000', '111101111'].indexOf(sum) >= 0) {
	      return 'sa';
	    }
	    // Full
	    if (['111111111', '000000000'].indexOf(sum) >= 0) {
	      return 'sf';
	    }
	
	    // X intersections
	    if (['101000101', '010111010'].indexOf(sum) >= 0) {
	      return 'x';
	    } // X
	    // X (3 tiles)
	    if (['101000100', '010111011'].indexOf(sum) >= 0) {
	      return 'x3t';
	    }
	    if (['101000001', '010111110'].indexOf(sum) >= 0) {
	      return 'x3l';
	    }
	    if (['001000101', '110111010'].indexOf(sum) >= 0) {
	      return 'x3b';
	    }
	    if (['100000101', '011111010'].indexOf(sum) >= 0) {
	      return 'x3r';
	    }
	    // X (2 tiles)
	    if (['101000000', '010111111'].indexOf(sum) >= 0) {
	      return 'x2t';
	    }
	    if (['001000001', '110111110'].indexOf(sum) >= 0) {
	      return 'x2l';
	    }
	    if (['000000101', '111111010'].indexOf(sum) >= 0) {
	      return 'x2b';
	    }
	    if (['100000100', '011111011'].indexOf(sum) >= 0) {
	      return 'x2r';
	    }
	    // X (1 tile)
	    if (['100000000', '111111110'].indexOf(sum) >= 0) {
	      return 'x1tl';
	    }
	    if (['001000000', '110111111'].indexOf(sum) >= 0) {
	      return 'x1tr';
	    }
	    if (['000000001', '111111110'].indexOf(sum) >= 0) {
	      return 'x1br';
	    }
	    if (['000000100', '111111011'].indexOf(sum) >= 0) {
	      return 'x1bl';
	    }
	  };
	  /**
	...
	var test = ['11111111111111', '11000000000011', '11011101101011', '11011101101011', '11011101101011', '11000000000011', '11011100100011', '11000000000011', '11001111110011', '11001000010011', '11001111110011', '11000000000011', '11001101011111', '11111111111111'];
	var testArr = [];
